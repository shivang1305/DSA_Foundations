...
public static Node transBackFromLeftClonedTree(Node node){
    ...
    // faith - think as a root of this tree
    Node leftNormal = transBackFromLeftClonedTree(node.left.left);
    Node rightNormal = transBackFromLeftClonedTree(node.right);
    
    // expectations (postorder)
